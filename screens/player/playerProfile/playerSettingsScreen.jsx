...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //Update player's phone after pressing in edit text
  const editPhone=async()=>{
    if(formState.inputValidities.phone){
        try{
            if(formState.inputValues.phone === player[0].phone){
              Alert.alert('Erreur!','Votre nouveau numéro de téléphone doit être différent d\'ancien numéro de téléphone.',[{text:"Réessayer"}]);
              return;
            }
            setIsLoading(true);
            dispatch(playerActions.updatePlayerPhone(formState.inputValues.phone,formState.inputValues.phone,
                                                   player[0].id));
            dispatch(authActions.updateUserPhoneFRB(formState.inputValues.phone,playerUID));                                       
            setIsLoading(false);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //Update player's password after pressing in edit text
              ...
              <View style={styles.card}>
                <View style={styles.firstRow}>
                    <Input
                      ...
                      initialValue={player[0]?player[0].phone:''}
                      initiallyValid={true}
                      phone
                      required
...
PlayerSettingsScreen.navigationOptions = () => {
